...
class Contactus extends Authorize_Controller {
	
	function __construct()
	{
		parent::__construct();
		$this->data['current_page'] = 'dashboard';	
		$this->load->model(array('contactus_m','global_m'));
	...
	function listcontactus()
	{
		...
		$config['base_url'] = base_url('contactus/listcontactus/page/');
		$config['total_rows'] = $this->contactus_m->total_data();
		$config['per_page'] = 10;
		...
		$this->data['data'] = $this->contactus_m->all($config['per_page'], $offset);
