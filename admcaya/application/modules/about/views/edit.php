                  ...
                  <div class="row">
                      <div class="row column-seperation">
                         ...
                         <div class="form-group">
                          ...
                          <?php echo form_input(array('name'=>'button', 'id'=>'title','placeholder'=>'Enter Your Button Title', 'class'=>'form-control', 'required'=>'required'),stripslashes(htmlspecialchars_decode(html_entity_decode($dataslide['button'])))); ?>     
