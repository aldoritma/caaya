              ...
              <div class="col-lg-7 col-md-6 ">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                   ...
                   <?php echo form_open(base_url('user/account-setting/post'), 'id="form-personal" class="form_update" role="form" autocomplete="off"'); ?>
                      <div class="row">
                        <div class="col-sm-12">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="form-group form-group-default required">
                            ...
                            <?php echo form_input(array('name'=>'telephone', 'class'=>'form-control','placeholder'=>'Enter Your Phone Number'),$user['no_telp']); ?>
                       </div>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                            <label>Email</label>
                          <?php echo form_input(array('name'=>'email', 'class'=>'form-control','placeholder'=>'Email address'),$user['email']); ?>
                          </div>
