                ...
                <table class="table table-hover" width="100%">
                  ...
                  <?php $no= '1'; foreach ($listcat as $key => $data): ?>
                    <tr id="row_<?php echo $data['id'];?>">
                      ...
                      <td class="v-align-middle">
                        <p><?php echo ucwords($data['title']);?></p>
                      </td>
                      <td class="v-align-middle">
                          <div class="btn-group">     
                          <a href="<?php echo base_url('faq/editcat/'.$data['id'].''); ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>
                          </div>
                          <div class="btn-group">
  ...
  $(document).ready(function() {
    $('.delete').on('click', function(){
      if (confirm('Do you want to delete this Category?'))
      {
        ...
        $.get( base_url + "faq/delcat/" + id, function( data ) {
