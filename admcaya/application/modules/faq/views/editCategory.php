        ...
        <div class="content">
          <!-- START CONTAINER FLUID -->
            ...
            <?php endif; ?>
              ...
              <?php echo form_open(base_url('faq/editSavecat/'.$dataslide['id'].''), 'id="form-personal" class="form_update" role="form" autocomplete="off"'); ?>
              <!-- START PANEL -->
                      ...
                      <div class="tab-pane active" id="indonenesian">
                        <div class="row column-seperation">
                          <div class="form-group">
                            <label>Title</label>
                            <?php echo form_input(array('name'=>'catname', 'id'=>'catname','placeholder'=>'Enter Your Title', 'class'=>'form-control', 'required'=>'required'), $dataslide['title']); ?>
